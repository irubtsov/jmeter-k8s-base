...
RUN curl ${CURL_OPTS} --location --output "${JMETER_INSTALLATION_PATH}/lib/ext/jmeter-plugins-influxdb2-listener-2.7.jar"  "https://github.com/mderevyankoaqa/jmeter-influxdb2-listener-plugin/releases/download/v2.7/jmeter-plugins-influxdb2-listener-2.7.jar"
